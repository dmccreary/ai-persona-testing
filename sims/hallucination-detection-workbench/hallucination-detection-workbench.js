...
// 01. Hallucination Detection Workbench
// 02. The left pane shows a product brief with numbered evidence sentences.
// 03. The center pane shows a persona response with selectable claims.
// 04. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 05. Learners highlight a claim and attach an evidence sentence or classification.
// 06. Immediate feedback explains whether the evidence actually supports the claim.
// 07. Hallucination Detection Workbench
// 08. The left pane shows a product brief with numbered evidence sentences.
// 09. The center pane shows a persona response with selectable claims.
// 10. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 11. Learners highlight a claim and attach an evidence sentence or classification.
// 12. Immediate feedback explains whether the evidence actually supports the claim.
// 13. Hallucination Detection Workbench
// 14. The left pane shows a product brief with numbered evidence sentences.
// 15. The center pane shows a persona response with selectable claims.
// 16. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 17. Learners highlight a claim and attach an evidence sentence or classification.
// 18. Immediate feedback explains whether the evidence actually supports the claim.
// 19. Hallucination Detection Workbench
// 20. The left pane shows a product brief with numbered evidence sentences.
// 21. The center pane shows a persona response with selectable claims.
// 22. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 23. Learners highlight a claim and attach an evidence sentence or classification.
// 24. Immediate feedback explains whether the evidence actually supports the claim.
// 25. Hallucination Detection Workbench
// 26. The left pane shows a product brief with numbered evidence sentences.
// 27. The center pane shows a persona response with selectable claims.
// 28. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 29. Learners highlight a claim and attach an evidence sentence or classification.
// 30. Immediate feedback explains whether the evidence actually supports the claim.
// 31. Hallucination Detection Workbench
// 32. The left pane shows a product brief with numbered evidence sentences.
// 33. The center pane shows a persona response with selectable claims.
// 34. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 35. Learners highlight a claim and attach an evidence sentence or classification.
// 36. Immediate feedback explains whether the evidence actually supports the claim.
// 37. Hallucination Detection Workbench
// 38. The left pane shows a product brief with numbered evidence sentences.
// 39. The center pane shows a persona response with selectable claims.
// 40. The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.
// 41. Learners highlight a claim and attach an evidence sentence or classification.
// 42. Immediate feedback explains whether the evidence actually supports the claim.
// 43. Hallucination Detection Workbench
// 44. The left pane shows a product brief with numbered evidence sentences.
...
const simData={title:"Hallucination Detection Workbench", objective:"Validate model statements by tracing each factual claim to supplied context, external evidence, or an explicit persona interpretation.", bloom:"Apply", pattern:"Choose and practice", points:["Hallucination Detection Workbench", "The left pane shows a product brief with numbered evidence sentences.", "The center pane shows a persona response with selectable claims.", "The right pane displays claim status: Supported, Interpretation, Contradicted, or Unsupported.", "Learners highlight a claim and attach an evidence sentence or classification.", "Immediate feedback explains whether the evidence actually supports the claim."]};
