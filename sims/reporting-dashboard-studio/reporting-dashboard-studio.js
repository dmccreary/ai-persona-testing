...
// 01. Reporting and Dashboard Design Studio
// 02. Type: interactive infographic
// 03. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 04. Missing provenance blocks publication.
// 05. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 06. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 07. Reporting and Dashboard Design Studio
// 08. Type: interactive infographic
// 09. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 10. Missing provenance blocks publication.
// 11. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 12. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 13. Reporting and Dashboard Design Studio
// 14. Type: interactive infographic
// 15. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 16. Missing provenance blocks publication.
// 17. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 18. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 19. Reporting and Dashboard Design Studio
// 20. Type: interactive infographic
// 21. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 22. Missing provenance blocks publication.
// 23. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 24. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 25. Reporting and Dashboard Design Studio
// 26. Type: interactive infographic
// 27. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 28. Missing provenance blocks publication.
// 29. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 30. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 31. Reporting and Dashboard Design Studio
// 32. Type: interactive infographic
// 33. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 34. Missing provenance blocks publication.
// 35. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 36. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 37. Reporting and Dashboard Design Studio
// 38. Type: interactive infographic
// 39. Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.
// 40. Missing provenance blocks publication.
// 41. The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.
// 42. Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports.
// 43. Reporting and Dashboard Design Studio
...
const simData={title:"Reporting and Dashboard Design Studio", objective:"Compose executive, persona-comparison, heat-map, and recommendation views that preserve evidence, confidence, disagreement, accessibility, and decision context.", bloom:"Create", pattern:"Build and revise", points:["Reporting and Dashboard Design Studio", "Type: interactive infographic", "Learners select report widgets, connect each to graph queries, define audience and claim boundaries, and inspect drill-down paths.", "Missing provenance blocks publication.", "The studio flags decorative metrics, inaccessible color-only heat maps, hidden uncertainty, and executive summaries that omit severe minority findings.", "Dashboard grid becomes an ordered mobile layout with keyboard widget controls and text exports."]};
