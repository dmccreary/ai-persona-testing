// Visual Identity Evaluation Studio
// CANVAS_HEIGHT: 700
// Instructional design notes (generated from the approved specification):
// 01. Visual Identity Evaluation Studio
// 02. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 03. Persona and expert views remain separate.
// 04. Size, background, color mode, viewing distance, persona, and asset context.
// 05. Clicking an element reveals evaluation criteria and evidence.
// 06. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 07. Visual Identity Evaluation Studio
// 08. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 09. Persona and expert views remain separate.
// 10. Size, background, color mode, viewing distance, persona, and asset context.
// 11. Clicking an element reveals evaluation criteria and evidence.
// 12. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 13. Visual Identity Evaluation Studio
// 14. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 15. Persona and expert views remain separate.
// 16. Size, background, color mode, viewing distance, persona, and asset context.
// 17. Clicking an element reveals evaluation criteria and evidence.
// 18. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 19. Visual Identity Evaluation Studio
// 20. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 21. Persona and expert views remain separate.
// 22. Size, background, color mode, viewing distance, persona, and asset context.
// 23. Clicking an element reveals evaluation criteria and evidence.
// 24. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 25. Visual Identity Evaluation Studio
// 26. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 27. Persona and expert views remain separate.
// 28. Size, background, color mode, viewing distance, persona, and asset context.
// 29. Clicking an element reveals evaluation criteria and evidence.
// 30. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 31. Visual Identity Evaluation Studio
// 32. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 33. Persona and expert views remain separate.
// 34. Size, background, color mode, viewing distance, persona, and asset context.
// 35. Clicking an element reveals evaluation criteria and evidence.
// 36. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 37. Visual Identity Evaluation Studio
// 38. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
// 39. Persona and expert views remain separate.
// 40. Size, background, color mode, viewing distance, persona, and asset context.
// 41. Clicking an element reveals evaluation criteria and evidence.
// 42. The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure.
// 43. Visual Identity Evaluation Studio
// 44. Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.
...
const simData={title:"Visual Identity Evaluation Studio", objective:"Assess a visual identity and logo across recognition, meaning, legibility, accessibility, scale, context, and brand alignment.", bloom:"Create", pattern:"Build and revise", points:["Visual Identity Evaluation Studio", "Learners test an identity on mobile headers, invoices, social icons, presentations, packaging, and monochrome backgrounds.", "Persona and expert views remain separate.", "Size, background, color mode, viewing distance, persona, and asset context.", "Clicking an element reveals evaluation criteria and evidence.", "The studio flags conclusions unsupported by observation and distinguishes subjective preference from task failure."]};
