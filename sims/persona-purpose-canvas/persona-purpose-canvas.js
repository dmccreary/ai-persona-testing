...
// 02. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 03. A scenario tray provides evidence and business-decision cards.
// 04. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 05. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 06. Clicking a card explains its relevance.
// 07. Type: interactive infographic
// 08. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 09. A scenario tray provides evidence and business-decision cards.
// 10. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 11. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 12. Clicking a card explains its relevance.
// 13. Type: interactive infographic
// 14. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 15. A scenario tray provides evidence and business-decision cards.
// 16. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 17. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 18. Clicking a card explains its relevance.
// 19. Type: interactive infographic
// 20. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 21. A scenario tray provides evidence and business-decision cards.
// 22. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 23. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 24. Clicking a card explains its relevance.
// 25. Type: interactive infographic
// 26. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 27. A scenario tray provides evidence and business-decision cards.
// 28. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 29. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 30. Clicking a card explains its relevance.
// 31. Type: interactive infographic
// 32. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 33. A scenario tray provides evidence and business-decision cards.
// 34. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 35. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 36. Clicking a card explains its relevance.
// 37. Type: interactive infographic
// 38. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
// 39. A scenario tray provides evidence and business-decision cards.
// 40. Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.
// 41. The system flags purposes that name only demographics, omit a decision, or claim population authority.
// 42. Clicking a card explains its relevance.
// 43. Type: interactive infographic
// 44. Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.
...
const simData={title:"Persona Purpose Canvas", objective:"Formulate a bounded persona purpose connecting a customer pattern, use context, evaluation task, decision, and explicit exclusions.", bloom:"Create", pattern:"Build and revise", points:["Type: interactive infographic", "Five responsive canvas zones labeled Represents, Situation, Evaluates, Informs, and Does Not Establish.", "A scenario tray provides evidence and business-decision cards.", "Learners drag relevant cards into zones, discard irrelevant detail, and edit a generated purpose sentence.", "The system flags purposes that name only demographics, omit a decision, or claim population authority.", "Clicking a card explains its relevance."]};
