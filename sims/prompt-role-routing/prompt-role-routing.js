...
// 02. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 03. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 04. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 05. A combined workflow view shows message handoffs.
// 06. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 07. Type: interactive infographic
// 08. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 09. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 10. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 11. A combined workflow view shows message handoffs.
// 12. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 13. Type: interactive infographic
// 14. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 15. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 16. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 17. A combined workflow view shows message handoffs.
// 18. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 19. Type: interactive infographic
// 20. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 21. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 22. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 23. A combined workflow view shows message handoffs.
// 24. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 25. Type: interactive infographic
// 26. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 27. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 28. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 29. A combined workflow view shows message handoffs.
// 30. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 31. Type: interactive infographic
// 32. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 33. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 34. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 35. A combined workflow view shows message handoffs.
// 36. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 37. Type: interactive infographic
// 38. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
// 39. Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.
// 40. Every card explains why it belongs to a role and what failure occurs when roles are blended.
// 41. A combined workflow view shows message handoffs.
// 42. Role panels become tabs on narrow screens, with keyboard routing and resize handling.
// 43. Type: interactive infographic
// 44. Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.
...
const simData={title:"Prompt Role Routing Lab", objective:"Classify instructions by persona, moderator, reviewer, skeptic, or evaluation role and repair conflicting authority.", bloom:"Create", pattern:"Build and revise", points:["Type: interactive infographic", "Learners route instruction cards to role panels, inspect conflicts, and rewrite misplaced instructions.", "Scenarios include a moderator scoring participants, a persona writing executive recommendations, and a skeptic refusing valid evidence.", "Every card explains why it belongs to a role and what failure occurs when roles are blended.", "A combined workflow view shows message handoffs.", "Role panels become tabs on narrow screens, with keyboard routing and resize handling."]};
