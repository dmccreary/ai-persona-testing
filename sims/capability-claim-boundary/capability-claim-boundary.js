...
// 01. Capability and Claim Boundary Explorer
// 02. Type: interactive infographic
// 03. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 04. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 05. Learners pair a claim with available evidence and place it in a zone.
// 06. Feedback explains whether the wording exceeds the evidence.
// 07. Capability and Claim Boundary Explorer
// 08. Type: interactive infographic
// 09. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 10. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 11. Learners pair a claim with available evidence and place it in a zone.
// 12. Feedback explains whether the wording exceeds the evidence.
// 13. Capability and Claim Boundary Explorer
// 14. Type: interactive infographic
// 15. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 16. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 17. Learners pair a claim with available evidence and place it in a zone.
// 18. Feedback explains whether the wording exceeds the evidence.
// 19. Capability and Claim Boundary Explorer
// 20. Type: interactive infographic
// 21. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 22. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 23. Learners pair a claim with available evidence and place it in a zone.
// 24. Feedback explains whether the wording exceeds the evidence.
// 25. Capability and Claim Boundary Explorer
// 26. Type: interactive infographic
// 27. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 28. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 29. Learners pair a claim with available evidence and place it in a zone.
// 30. Feedback explains whether the wording exceeds the evidence.
// 31. Capability and Claim Boundary Explorer
// 32. Type: interactive infographic
// 33. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 34. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 35. Learners pair a claim with available evidence and place it in a zone.
// 36. Feedback explains whether the wording exceeds the evidence.
// 37. Capability and Claim Boundary Explorer
// 38. Type: interactive infographic
// 39. A responsive three-zone board labeled Generate, Investigate, and Validate.
// 40. Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.
// 41. Learners pair a claim with available evidence and place it in a zone.
// 42. Feedback explains whether the wording exceeds the evidence.
// 43. Capability and Claim Boundary Explorer
...
const simData={title:"Capability and Claim Boundary Explorer", objective:"Judge whether an AI persona task supports brainstorming, directional insight, or a validated customer claim.", bloom:"Evaluate", pattern:"Judge with evidence", points:["Capability and Claim Boundary Explorer", "Type: interactive infographic", "A responsive three-zone board labeled Generate, Investigate, and Validate.", "Marketing claim cards appear beside evidence cards describing model outputs, analytics, interviews, surveys, or verified sources.", "Learners pair a claim with available evidence and place it in a zone.", "Feedback explains whether the wording exceeds the evidence."]};
