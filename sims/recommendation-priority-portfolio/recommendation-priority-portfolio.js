...
// 01. Recommendation Priority Portfolio
// 02. Type: interactive infographic
// 03. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 04. They can change criteria and inspect ranking stability.
// 05. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 06. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 07. Recommendation Priority Portfolio
// 08. Type: interactive infographic
// 09. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 10. They can change criteria and inspect ranking stability.
// 11. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 12. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 13. Recommendation Priority Portfolio
// 14. Type: interactive infographic
// 15. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 16. They can change criteria and inspect ranking stability.
// 17. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 18. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 19. Recommendation Priority Portfolio
// 20. Type: interactive infographic
// 21. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 22. They can change criteria and inspect ranking stability.
// 23. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 24. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 25. Recommendation Priority Portfolio
// 26. Type: interactive infographic
// 27. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 28. They can change criteria and inspect ranking stability.
// 29. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 30. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 31. Recommendation Priority Portfolio
// 32. Type: interactive infographic
// 33. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 34. They can change criteria and inspect ranking stability.
// 35. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 36. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 37. Recommendation Priority Portfolio
// 38. Type: interactive infographic
// 39. Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.
// 40. They can change criteria and inspect ranking stability.
// 41. The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.
// 42. Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling.
// 43. Recommendation Priority Portfolio
...
const simData={title:"Recommendation Priority Portfolio", objective:"Prioritize recommendations using risk, business impact, implementation effort, evidence confidence, dependencies, equity, and learning value.", bloom:"Create", pattern:"Build and revise", points:["Recommendation Priority Portfolio", "Type: interactive infographic", "Learners place recommendations on an Impact versus Effort canvas, then reveal risk and confidence overlays.", "They can change criteria and inspect ranking stability.", "The tool flags easy but low-value work, severe risks hidden by effort, duplicate recommendations, and actions unsupported by findings.", "Canvas becomes a sortable accessible list on narrow screens, with keyboard movement and resize handling."]};
