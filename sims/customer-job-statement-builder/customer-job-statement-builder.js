// Customer Job Statement Builder
// CANVAS_HEIGHT: 700
// Instructional design notes (generated from the approved specification):
// 01. Customer Job Statement Builder
// 02. Type: interactive infographic
// 03. Five sentence-building zones with a research-note tray.
// 04. A preview assembles the selected elements into a job statement.
// 05. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 06. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 07. Customer Job Statement Builder
// 08. Type: interactive infographic
// 09. Five sentence-building zones with a research-note tray.
// 10. A preview assembles the selected elements into a job statement.
// 11. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 12. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 13. Customer Job Statement Builder
// 14. Type: interactive infographic
// 15. Five sentence-building zones with a research-note tray.
// 16. A preview assembles the selected elements into a job statement.
// 17. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 18. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 19. Customer Job Statement Builder
// 20. Type: interactive infographic
// 21. Five sentence-building zones with a research-note tray.
// 22. A preview assembles the selected elements into a job statement.
// 23. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 24. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 25. Customer Job Statement Builder
// 26. Type: interactive infographic
// 27. Five sentence-building zones with a research-note tray.
// 28. A preview assembles the selected elements into a job statement.
// 29. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 30. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 31. Customer Job Statement Builder
// 32. Type: interactive infographic
// 33. Five sentence-building zones with a research-note tray.
// 34. A preview assembles the selected elements into a job statement.
// 35. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 36. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 37. Customer Job Statement Builder
// 38. Type: interactive infographic
// 39. Five sentence-building zones with a research-note tray.
// 40. A preview assembles the selected elements into a job statement.
// 41. Learners sort notes, edit language, and remove solution-specific or demographic wording.
// 42. Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress.
// 43. Customer Job Statement Builder
...
const simData={title:"Customer Job Statement Builder", objective:"Formulate an evidence-grounded customer job statement containing circumstance, desired progress, functional outcome, emotional outcome, and social responsibility.", bloom:"Create", pattern:"Build and revise", points:["Customer Job Statement Builder", "Type: interactive infographic", "Five sentence-building zones with a research-note tray.", "A preview assembles the selected elements into a job statement.", "Learners sort notes, edit language, and remove solution-specific or demographic wording.", "Feedback flags statements that name a product, lack a circumstance, or confuse the company's objective with customer progress."]};
