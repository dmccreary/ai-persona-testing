...
| 3 | MicroSims | 82 | Recommended | Interactive simulations in docs/sims/ |
...
| 8 | FAQs | 82 | Recommended | Questions in faq.md |
| 9 | Words | 153,530 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 81 | 81 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 0 | LaTeX expressions (inline and display) |
| Total Words | 153,530 | 100,086 | Words in markdown files |
| Links | 799 | 296 | Hyperlinks in markdown format |
| Equivalent Pages | 675 | 461 | Estimated pages (250 words/page + visuals) |
