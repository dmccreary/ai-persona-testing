...
| Mermaid diagrams | :x: | Trivial | SuperFences is enabled, but no Mermaid custom fence or JavaScript renderer is configured |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 400 terms with ISO 11179 compliant definitions |
| FAQ page | :white_check_mark: | Medium | 82 answers to common student questions |
| References page | :x: | Medium | Curated bibliography with links — site-wide or per-chapter |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Social media preview cards | :white_check_mark: | Medium | Cairo-free MkDocs hook injects Open Graph and Twitter metadata using `img/cover.png` |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 82 runnable browser apps; the raw scanner's 83 directories include the non-runnable `sims/TODO` folder |
| MicroSim index catalog | :white_check_mark: | Medium | Visual gallery with cards showing all available simulations |
| Per-chapter quizzes | :white_check_mark: | High | 20 quiz files with questions aligned to learning objectives |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Chapter content | :white_check_mark: | Very High | 20 chapters with full text, examples, and exercises |
| Pedagogical Agent (Mascot) | :white_check_mark: | High | Lens the Evidence Explorer with seven poses and custom admonitions |
