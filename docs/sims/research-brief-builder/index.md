...
status: deployed
quality_score: 98
image: /sims/research-brief-builder/research-brief-builder.png
og:image: /sims/research-brief-builder/research-brief-builder.png
twitter:image: /sims/research-brief-builder/research-brief-builder.png
social:
   cards: false
---
...
[Run the Research Brief Builder MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }

[Edit in the p5.js Editor](https://editor.p5js.org/)

## About This MicroSim

Formulate a coherent research brief that connects a marketing decision to questions, objectives, scope, assumptions, constraints, and evidence criteria.
...
```html
<iframe src="https://dmccreary.github.io/ai-persona-testing/sims/research-brief-builder/main.html" height="702" width="100%" scrolling="no"></iframe>
```
