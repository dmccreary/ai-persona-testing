...
// 01. Persona Evidence Layer Builder
// 02. Type: interactive infographic
// 03. A layered profile silhouette beside an evidence tray.
// 04. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 05. Learners drag statements from interview notes and analytics into layers.
// 06. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 07. Persona Evidence Layer Builder
// 08. Type: interactive infographic
// 09. A layered profile silhouette beside an evidence tray.
// 10. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 11. Learners drag statements from interview notes and analytics into layers.
// 12. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 13. Persona Evidence Layer Builder
// 14. Type: interactive infographic
// 15. A layered profile silhouette beside an evidence tray.
// 16. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 17. Learners drag statements from interview notes and analytics into layers.
// 18. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 19. Persona Evidence Layer Builder
// 20. Type: interactive infographic
// 21. A layered profile silhouette beside an evidence tray.
// 22. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 23. Learners drag statements from interview notes and analytics into layers.
// 24. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 25. Persona Evidence Layer Builder
// 26. Type: interactive infographic
// 27. A layered profile silhouette beside an evidence tray.
// 28. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 29. Learners drag statements from interview notes and analytics into layers.
// 30. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 31. Persona Evidence Layer Builder
// 32. Type: interactive infographic
// 33. A layered profile silhouette beside an evidence tray.
// 34. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 35. Learners drag statements from interview notes and analytics into layers.
// 36. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 37. Persona Evidence Layer Builder
// 38. Type: interactive infographic
// 39. A layered profile silhouette beside an evidence tray.
// 40. Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.
// 41. Learners drag statements from interview notes and analytics into layers.
// 42. They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed.
// 43. Persona Evidence Layer Builder
...
const simData={title:"Persona Evidence Layer Builder", objective:"Classify research statements as behavior, preference, attitude, value, belief, demographic, psychographic, background, or context and connect each statement to evidence.", bloom:"Analyze", pattern:"Compare and inspect", points:["Persona Evidence Layer Builder", "Type: interactive infographic", "A layered profile silhouette beside an evidence tray.", "Layers represent observable action, expressed choice, evaluation, guiding principle, accepted proposition, identity context, and situation.", "Learners drag statements from interview notes and analytics into layers.", "They then attach a source and set evidence status to Observed, Reported, Inferred, or Assumed."]};
