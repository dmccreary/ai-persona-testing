...
status: deployed
quality_score: 98
image: /sims/information-channel-fit/information-channel-fit.png
og:image: /sims/information-channel-fit/information-channel-fit.png
twitter:image: /sims/information-channel-fit/information-channel-fit.png
social:
   cards: false
---
...
[Run the Information and Channel Fit Lab MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }

[Edit in the p5.js Editor](https://editor.p5js.org/)

## About This MicroSim

Use persona information needs, media habits, channel preferences, technology comfort, context, and accessibility requirements to choose an appropriate communication path.
...
```html
<iframe src="https://dmccreary.github.io/ai-persona-testing/sims/information-channel-fit/main.html" height="702" width="100%" scrolling="no"></iframe>
```
