...
// 01. Information and Channel Fit Lab
// 02. Type: interactive infographic
// 03. A matrix with journey stages as columns and information tasks as rows.
// 04. Message cards and channel cards sit in a tray.
// 05. Learners place a message and channel at each stage for a selected persona.
// 06. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 07. Information and Channel Fit Lab
// 08. Type: interactive infographic
// 09. A matrix with journey stages as columns and information tasks as rows.
// 10. Message cards and channel cards sit in a tray.
// 11. Learners place a message and channel at each stage for a selected persona.
// 12. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 13. Information and Channel Fit Lab
// 14. Type: interactive infographic
// 15. A matrix with journey stages as columns and information tasks as rows.
// 16. Message cards and channel cards sit in a tray.
// 17. Learners place a message and channel at each stage for a selected persona.
// 18. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 19. Information and Channel Fit Lab
// 20. Type: interactive infographic
// 21. A matrix with journey stages as columns and information tasks as rows.
// 22. Message cards and channel cards sit in a tray.
// 23. Learners place a message and channel at each stage for a selected persona.
// 24. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 25. Information and Channel Fit Lab
// 26. Type: interactive infographic
// 27. A matrix with journey stages as columns and information tasks as rows.
// 28. Message cards and channel cards sit in a tray.
// 29. Learners place a message and channel at each stage for a selected persona.
// 30. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 31. Information and Channel Fit Lab
// 32. Type: interactive infographic
// 33. A matrix with journey stages as columns and information tasks as rows.
// 34. Message cards and channel cards sit in a tray.
// 35. Learners place a message and channel at each stage for a selected persona.
// 36. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 37. Information and Channel Fit Lab
// 38. Type: interactive infographic
// 39. A matrix with journey stages as columns and information tasks as rows.
// 40. Message cards and channel cards sit in a tray.
// 41. Learners place a message and channel at each stage for a selected persona.
// 42. Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check.
// 43. Information and Channel Fit Lab
...
const simData={title:"Information and Channel Fit Lab", objective:"Use persona information needs, media habits, channel preferences, technology comfort, context, and accessibility requirements to choose an appropriate communication path.", bloom:"Create", pattern:"Build and revise", points:["Information and Channel Fit Lab", "Type: interactive infographic", "A matrix with journey stages as columns and information tasks as rows.", "Message cards and channel cards sit in a tray.", "Learners place a message and channel at each stage for a selected persona.", "Feedback explains mismatches, such as using a public social channel for a private account issue or a long video for an urgent factual check."]};
