...
// 01. Evidence-Preserving Synthesis Workbench
// 02. Type: interactive infographic
// 03. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 04. A devil's-advocate control introduces a supported counterargument.
// 05. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 06. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 07. Evidence-Preserving Synthesis Workbench
// 08. Type: interactive infographic
// 09. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 10. A devil's-advocate control introduces a supported counterargument.
// 11. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 12. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 13. Evidence-Preserving Synthesis Workbench
// 14. Type: interactive infographic
// 15. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 16. A devil's-advocate control introduces a supported counterargument.
// 17. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 18. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 19. Evidence-Preserving Synthesis Workbench
// 20. Type: interactive infographic
// 21. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 22. A devil's-advocate control introduces a supported counterargument.
// 23. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 24. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 25. Evidence-Preserving Synthesis Workbench
// 26. Type: interactive infographic
// 27. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 28. A devil's-advocate control introduces a supported counterargument.
// 29. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 30. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 31. Evidence-Preserving Synthesis Workbench
// 32. Type: interactive infographic
// 33. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 34. A devil's-advocate control introduces a supported counterargument.
// 35. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 36. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 37. Evidence-Preserving Synthesis Workbench
// 38. Type: interactive infographic
// 39. Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.
// 40. A devil's-advocate control introduces a supported counterargument.
// 41. The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.
// 42. Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling.
// 43. Evidence-Preserving Synthesis Workbench
...
const simData={title:"Evidence-Preserving Synthesis Workbench", objective:"Synthesize multi-agent findings while preserving citations, minority opinions, conflicts, uncertainty, and distinct expert critique.", bloom:"Create", pattern:"Build and revise", points:["Evidence-Preserving Synthesis Workbench", "Type: interactive infographic", "Learners group structured findings into themes, inspect source links, classify conflicts, and draft a synthesis.", "A devil's-advocate control introduces a supported counterargument.", "The workbench flags unsupported merging, vanished minority evidence, double-counted duplicate agents, and recommendations attributed to personas.", "Evidence tray and synthesis canvas stack on narrow screens, with keyboard grouping, text export, and resize handling."]};
