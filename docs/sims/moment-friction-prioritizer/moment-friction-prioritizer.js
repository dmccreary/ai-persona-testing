...
// 01. Moment and Friction Prioritizer
// 02. Type: interactive infographic
// 03. Touchpoint cards plot on an Impact versus Evidence matrix.
// 04. Additional badges show frequency, affected persona, and whether friction is necessary.
// 05. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 06. Feedback warns when frequency hides severe accessibility harm.
// 07. Moment and Friction Prioritizer
// 08. Type: interactive infographic
// 09. Touchpoint cards plot on an Impact versus Evidence matrix.
// 10. Additional badges show frequency, affected persona, and whether friction is necessary.
// 11. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 12. Feedback warns when frequency hides severe accessibility harm.
// 13. Moment and Friction Prioritizer
// 14. Type: interactive infographic
// 15. Touchpoint cards plot on an Impact versus Evidence matrix.
// 16. Additional badges show frequency, affected persona, and whether friction is necessary.
// 17. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 18. Feedback warns when frequency hides severe accessibility harm.
// 19. Moment and Friction Prioritizer
// 20. Type: interactive infographic
// 21. Touchpoint cards plot on an Impact versus Evidence matrix.
// 22. Additional badges show frequency, affected persona, and whether friction is necessary.
// 23. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 24. Feedback warns when frequency hides severe accessibility harm.
// 25. Moment and Friction Prioritizer
// 26. Type: interactive infographic
// 27. Touchpoint cards plot on an Impact versus Evidence matrix.
// 28. Additional badges show frequency, affected persona, and whether friction is necessary.
// 29. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 30. Feedback warns when frequency hides severe accessibility harm.
// 31. Moment and Friction Prioritizer
// 32. Type: interactive infographic
// 33. Touchpoint cards plot on an Impact versus Evidence matrix.
// 34. Additional badges show frequency, affected persona, and whether friction is necessary.
// 35. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 36. Feedback warns when frequency hides severe accessibility harm.
// 37. Moment and Friction Prioritizer
// 38. Type: interactive infographic
// 39. Touchpoint cards plot on an Impact versus Evidence matrix.
// 40. Additional badges show frequency, affected persona, and whether friction is necessary.
// 41. Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.
// 42. Feedback warns when frequency hides severe accessibility harm.
// 43. Moment and Friction Prioritizer
...
const simData={title:"Moment and Friction Prioritizer", objective:"Prioritize journey opportunities by customer impact, frequency, severity, equity, evidence strength, and implementation risk.", bloom:"Create", pattern:"Build and revise", points:["Moment and Friction Prioritizer", "Type: interactive infographic", "Touchpoint cards plot on an Impact versus Evidence matrix.", "Additional badges show frequency, affected persona, and whether friction is necessary.", "Learners inspect evidence, adjust criteria weights, compare two personas, and move proposed opportunities into Now, Investigate, or Later.", "Feedback warns when frequency hides severe accessibility harm."]};
