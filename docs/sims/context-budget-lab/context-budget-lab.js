...
// 01. Context Budget Laboratory
// 02. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 03. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 04. Learners must fit a scenario within the budget.
// 05. Removing essential context triggers a specific predicted failure.
// 06. Compression choices reveal what was preserved or lost.
// 07. Context Budget Laboratory
// 08. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 09. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 10. Learners must fit a scenario within the budget.
// 11. Removing essential context triggers a specific predicted failure.
// 12. Compression choices reveal what was preserved or lost.
// 13. Context Budget Laboratory
// 14. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 15. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 16. Learners must fit a scenario within the budget.
// 17. Removing essential context triggers a specific predicted failure.
// 18. Compression choices reveal what was preserved or lost.
// 19. Context Budget Laboratory
// 20. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 21. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 22. Learners must fit a scenario within the budget.
// 23. Removing essential context triggers a specific predicted failure.
// 24. Compression choices reveal what was preserved or lost.
// 25. Context Budget Laboratory
// 26. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 27. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 28. Learners must fit a scenario within the budget.
// 29. Removing essential context triggers a specific predicted failure.
// 30. Compression choices reveal what was preserved or lost.
// 31. Context Budget Laboratory
// 32. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 33. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 34. Learners must fit a scenario within the budget.
// 35. Removing essential context triggers a specific predicted failure.
// 36. Compression choices reveal what was preserved or lost.
// 37. Context Budget Laboratory
// 38. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
// 39. Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.
// 40. Learners must fit a scenario within the budget.
// 41. Removing essential context triggers a specific predicted failure.
// 42. Compression choices reveal what was preserved or lost.
// 43. Context Budget Laboratory
// 44. Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.
...
const simData={title:"Context Budget Laboratory", objective:"Prioritize and compress prompt context while preserving instructions, verified facts, persona fidelity, criteria, uncertainty, and source traceability.", bloom:"Create", pattern:"Build and revise", points:["Context Budget Laboratory", "Context-window budget, item cards with token costs, priority, sensitivity, age, and source status; Compress, Reference, Exclude, and Restore actions.", "Visual elements: A context meter and quality indicators for Role Fidelity, Evidence, Criteria, Safety, and Traceability.", "Learners must fit a scenario within the budget.", "Removing essential context triggers a specific predicted failure.", "Compression choices reveal what was preserved or lost."]};
