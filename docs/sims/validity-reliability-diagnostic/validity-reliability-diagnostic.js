...
// 01. Validity and Reliability Diagnostic
// 02. Type: interactive infographic
// 03. A two-by-two validity/reliability matrix beside a scenario panel.
// 04. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 05. Learners place each scenario in the matrix and select a correction.
// 06. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 07. Validity and Reliability Diagnostic
// 08. Type: interactive infographic
// 09. A two-by-two validity/reliability matrix beside a scenario panel.
// 10. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 11. Learners place each scenario in the matrix and select a correction.
// 12. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 13. Validity and Reliability Diagnostic
// 14. Type: interactive infographic
// 15. A two-by-two validity/reliability matrix beside a scenario panel.
// 16. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 17. Learners place each scenario in the matrix and select a correction.
// 18. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 19. Validity and Reliability Diagnostic
// 20. Type: interactive infographic
// 21. A two-by-two validity/reliability matrix beside a scenario panel.
// 22. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 23. Learners place each scenario in the matrix and select a correction.
// 24. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 25. Validity and Reliability Diagnostic
// 26. Type: interactive infographic
// 27. A two-by-two validity/reliability matrix beside a scenario panel.
// 28. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 29. Learners place each scenario in the matrix and select a correction.
// 30. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 31. Validity and Reliability Diagnostic
// 32. Type: interactive infographic
// 33. A two-by-two validity/reliability matrix beside a scenario panel.
// 34. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 35. Learners place each scenario in the matrix and select a correction.
// 36. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 37. Validity and Reliability Diagnostic
// 38. Type: interactive infographic
// 39. A two-by-two validity/reliability matrix beside a scenario panel.
// 40. Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.
// 41. Learners place each scenario in the matrix and select a correction.
// 42. The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions.
// 43. Validity and Reliability Diagnostic
...
const simData={title:"Validity and Reliability Diagnostic", objective:"Distinguish threats to research validity from threats to research reliability and recommend an appropriate design correction.", bloom:"Create", pattern:"Build and revise", points:["Validity and Reliability Diagnostic", "Type: interactive infographic", "A two-by-two validity/reliability matrix beside a scenario panel.", "Scenarios include a leading persona prompt, changing rubrics between runs, surveying only loyal customers, and measuring visual appeal as a substitute for trust.", "Learners place each scenario in the matrix and select a correction.", "The system highlights the relevant words in the scenario, explains the threat, and shows how one problem can affect both dimensions."]};
