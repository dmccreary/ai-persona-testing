...
// 01. Agent Specification Builder
// 02. Type: interactive infographic
// 03. Learners assemble specification cards for a marketing scenario.
// 04. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 05. Clicking a component reveals its contract and one failure caused by omission.
// 06. Export produces a reviewable agent card.
// 07. Agent Specification Builder
// 08. Type: interactive infographic
// 09. Learners assemble specification cards for a marketing scenario.
// 10. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 11. Clicking a component reveals its contract and one failure caused by omission.
// 12. Export produces a reviewable agent card.
// 13. Agent Specification Builder
// 14. Type: interactive infographic
// 15. Learners assemble specification cards for a marketing scenario.
// 16. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 17. Clicking a component reveals its contract and one failure caused by omission.
// 18. Export produces a reviewable agent card.
// 19. Agent Specification Builder
// 20. Type: interactive infographic
// 21. Learners assemble specification cards for a marketing scenario.
// 22. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 23. Clicking a component reveals its contract and one failure caused by omission.
// 24. Export produces a reviewable agent card.
// 25. Agent Specification Builder
// 26. Type: interactive infographic
// 27. Learners assemble specification cards for a marketing scenario.
// 28. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 29. Clicking a component reveals its contract and one failure caused by omission.
// 30. Export produces a reviewable agent card.
// 31. Agent Specification Builder
// 32. Type: interactive infographic
// 33. Learners assemble specification cards for a marketing scenario.
// 34. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 35. Clicking a component reveals its contract and one failure caused by omission.
// 36. Export produces a reviewable agent card.
// 37. Agent Specification Builder
// 38. Type: interactive infographic
// 39. Learners assemble specification cards for a marketing scenario.
// 40. The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.
// 41. Clicking a component reveals its contract and one failure caused by omission.
// 42. Export produces a reviewable agent card.
// 43. Agent Specification Builder
...
const simData={title:"Agent Specification Builder", objective:"Design a bounded AI agent specification connecting role, goal, instructions, context, memory, tools, output, autonomy, and boundaries.", bloom:"Create", pattern:"Build and revise", points:["Agent Specification Builder", "Type: interactive infographic", "Learners assemble specification cards for a marketing scenario.", "The tool flags goals outside the role, tools without purpose, memory without retention rules, outputs without consumers, and autonomy without escalation.", "Clicking a component reveals its contract and one failure caused by omission.", "Export produces a reviewable agent card."]};
