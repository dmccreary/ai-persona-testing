// Message Element Testing Lab
// CANVAS_HEIGHT: 700
// Instructional design notes (generated from the approved specification):
// 01. Message Element Testing Lab
// 02. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 03. Feedback compares interpretation with intended purpose and evidence.
// 04. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 05. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 06. Context manipulation and prediction support applied message evaluation.
// 07. Message Element Testing Lab
// 08. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 09. Feedback compares interpretation with intended purpose and evidence.
// 10. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 11. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 12. Context manipulation and prediction support applied message evaluation.
// 13. Message Element Testing Lab
// 14. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 15. Feedback compares interpretation with intended purpose and evidence.
// 16. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 17. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 18. Context manipulation and prediction support applied message evaluation.
// 19. Message Element Testing Lab
// 20. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 21. Feedback compares interpretation with intended purpose and evidence.
// 22. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 23. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 24. Context manipulation and prediction support applied message evaluation.
// 25. Message Element Testing Lab
// 26. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 27. Feedback compares interpretation with intended purpose and evidence.
// 28. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 29. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 30. Context manipulation and prediction support applied message evaluation.
// 31. Message Element Testing Lab
// 32. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 33. Feedback compares interpretation with intended purpose and evidence.
// 34. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 35. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 36. Context manipulation and prediction support applied message evaluation.
// 37. Message Element Testing Lab
// 38. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
// 39. Feedback compares interpretation with intended purpose and evidence.
// 40. Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.
// 41. Preview and interpretation panel stack on narrow screens with keyboard controls.
// 42. Context manipulation and prediction support applied message evaluation.
// 43. Message Element Testing Lab
// 44. Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.
...
const simData={title:"Message Element Testing Lab", objective:"Evaluate taglines, headlines, and calls to action in isolation and context across personas and journey stages.", bloom:"Create", pattern:"Build and revise", points:["Message Element Testing Lab", "Learners reveal message layers sequentially, record predicted meaning, switch personas, and test alternative action labels.", "Feedback compares interpretation with intended purpose and evidence.", "Element type, context amount, persona, journey stage, channel, and mobile/desktop preview.", "Preview and interpretation panel stack on narrow screens with keyboard controls.", "Context manipulation and prediction support applied message evaluation."]};
